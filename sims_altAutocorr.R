...
Sim_fct <- function(Tmax  = 270,        #Seconds per round
                    ...
                    alphaG = 0.3,      #Learning rate for gains
                    alphaL = 0.3,      #Learning rate for losses
                    betaQ  = 10,        #Inverse temperature
                    betaC  = 0.9,       #Choice autocorrelation
